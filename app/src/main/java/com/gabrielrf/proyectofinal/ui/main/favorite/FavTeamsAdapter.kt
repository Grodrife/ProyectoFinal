...
import com.gabrielrf.proyectofinal.ui.main.team.TeamDetailFragment
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class FavTeamsAdapter(private val teams: MutableList<DataTeam>, private val fragmentManager: FragmentManager): RecyclerView.Adapter<FavTeamsAdapter.ViewHolder>() {

    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavTeamsAdapter.ViewHolder {
        context = parent.context
        val view = LayoutInflater.from(context).inflate(R.layout.team_view, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: FavTeamsAdapter.ViewHolder, position: Int) {
